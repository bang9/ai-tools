...
export default function DirectoryFileList({
  entries,
  loading,
  selectedFile,
  onSelectFile,
        ...
        <div ref={scrollRef} className={cn("relative flex-1 overflow-y-auto")}>
          ...
          >
            {virtualRows.map((virtualRow) => {
              ...
              const selected = isFile && selectedFile === entry.path;
                ...
                >
                  <button
                    ...
                    className={cn(
                      ...
                      {
                        "cursor-pointer hover:bg-secondary/30 hover:text-foreground": isFile,
